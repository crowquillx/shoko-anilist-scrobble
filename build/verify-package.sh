...
for required in "Shoko.AniListScrobble.dll" "Shoko.AniListScrobble.deps.json" "Shoko.AniListScrobble.runtimeconfig.json"; do
...
[[ "$archive_name" == "Shoko.AniListScrobble-${expected_version}-any.zip" ]] \
