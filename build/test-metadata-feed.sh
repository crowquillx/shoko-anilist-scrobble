...
make_release() {
  ...
  jq -n \
    ...
    '$base[0]
     | .repository_url = "https://github.com/crowquillx/shoko-anilist-scrobble"
     ...
     | .releases = [{
         ...
         archives: [{
           runtime: "any",
           abstraction: "6.0.0",
           url: ("https://github.com/crowquillx/shoko-anilist-scrobble/releases/download/" + $tag + "/plugin.zip"),
